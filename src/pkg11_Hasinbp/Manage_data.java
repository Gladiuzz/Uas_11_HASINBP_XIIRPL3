 ...
 * @author Asus
 */
public class Manage_data extends javax.swing.JDialog {
    ...
    int baris;
    String action;
    public Manage_data(java.awt.Frame parent, boolean modal,String act ,String id_inventaris) {
        super(parent, modal);
        initComponents();
         action = act;
    ...
    private Manage_data(JFrame jFrame, boolean b) {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txt_kode, javax.swing.GroupLayout.DEFAULT_SIZE, 334, Short.MAX_VALUE))
                .addGap(32, 32, 32))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manage_data.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void insertdata(){
       ...
       try {
           String query = "INSERT INTO `inventaris` (`id_inventaris`, `nama`,`kondisi`,`keterangan`,`jumlah`,`id_jenis`,`tanggal_register`,`id_ruang`,`kode_inventaris`,`id_petugas`)"
   ...
   public void addKeterangan(){
       ...
       try {
            String query = "SELECT keterangan FROM jenis";
            stmt = connection.createStatement();
    ...
    public void addJenis(){
       ...
       try {
            String query = "SELECT id_jenis FROM jenis";
            stmt = connection.createStatement();
            rs = stmt.executeQuery(query);   
   ...
   public void addRuang(){
       ...
       try {
            String query = "SELECT id_ruang FROM ruang";
            stmt = connection.createStatement();
            rs = stmt.executeQuery(query);   
   ...
   public void addpetugas(){
       ...
       try {
            String query = "SELECT id_petugas FROM petugas";
            stmt = connection.createStatement();
            rs = stmt.executeQuery(query);   
   ...
   void ShowData(String id_inventaris){
        try{
            ...
            rs.next();
            txt_idInventaris.setText(rs.getString("id_inventaris"));
